...
"""This module contains the class to connect to a BalanceTrackerNvmSubscriptionNative contract."""
...
PUBLIC_ID = PublicId.from_str("valory/nvm_balance_tracker_native:0.1.0")


class BalanceTrackerNvmSubscriptionNative(Contract):
    """The BalanceTrackerNvmSubscriptionNative contract."""
