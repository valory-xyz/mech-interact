...
class TestCurrentMechResponse:
    ...
    def test_getter_returns_initial(self, response_behaviour: MagicMock) -> None:
        """Test getter returns the initial MechInteractionResponse."""
        assert isinstance(
            response_behaviour.current_mech_response, MechInteractionResponse
        )

    def test_setter_updates_shared_state(self, response_behaviour: MagicMock) -> None:
...
class TestSimpleProperties:
    ...
    def test_from_block_roundtrip(self, response_behaviour: MagicMock) -> None:
    ...
    def test_requests_setter_converts_dicts(
        self, response_behaviour: MagicMock
    ) -> None:
    ...
    def test_request_info_roundtrip(self, response_behaviour: MagicMock) -> None:
    ...
    def test_is_valid_acn_sender_roundtrip(self, response_behaviour: MagicMock) -> None:
...
class TestDeliveryMech:
    ...
    def test_returns_correct_index(self, response_behaviour: MagicMock) -> None:
...
class TestResponseHex:
    ...
    def test_setter_from_bytes(self, response_behaviour: MagicMock) -> None:
    ...
    def test_setter_from_string(self, response_behaviour: MagicMock) -> None:
